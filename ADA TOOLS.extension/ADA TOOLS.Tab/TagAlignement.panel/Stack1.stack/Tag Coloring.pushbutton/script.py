...
if not mep_tags:
    ...
    # Create red color for EHS (RGB: 255, 0, 0)
    ...
    try:
            ...
            try:
                ...
                if linked_element_id != ElementId.InvalidElementId:
                    ...
                    if link_instance:
                        ...
                        # Check if link name contains "HVC", "BLU", "CLU", "ELE", or "EHS"
                        if "HVC" in link_name.upper():
                            ...
                            ele_colored_count += 1
                        elif "EHS" in link_name.upper():
                            active_view.SetElementOverrides(tag.Id, red_override)
                            ehs_colored_count += 1
                        else:
                            skipped_count += 1
                    else:
        ...
        # message += "Tags colored RED (EHS linked model): {}\n".format(ehs_colored_count)
